...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {Developed a selection of 5 AWS Systems Manager (SSM) documents and automation using Terraform and GitLab CI/CD deployment which reduced the cost of conducting network connectivity testing by about 92.38\%.}
    \resumeItemListEnd
