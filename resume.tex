...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      {PayPal}{Austin, TX}
      \resumeItemListStart
      \resumeItem {Joining Venmo (PayPal) for an exciting, enriching, and character-building experience this upcoming summer!}
    \resumeItemListEnd
    \resumeSubheading
      {Software Engineer Intern (DevOps)}{May 2021 - July 2021}
      {USAA}{Plano, TX}
    \resumeItemListStart
      \resumeItem {Reduced cluttering by 84\% and allowed for easier feature-based auditing of a qTest archive by innovating a new directory structure for publishing automated infrastructure test results that affected 70 projects.}
