...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Georgia Institute of Technology}{Starting Jan. 2022}
      {M.S. Computer Science}{(Online) Atlanta, GA}
      \resumeItemListStart
        \resumeItem{\textbf{Accepted;} matriculating Spring 2022}
      \resumeItemListEnd
    \resumeSubheading
      {University of New Orleans}{Aug. 2019 - Dec. 2021 (expected)}
      {B.S. Computer Science, 3.987 GPA}{New Orleans, LA}
      \resumeItemListStart
        \resumeItem{\textbf{Activities:} Google Developer Student Club (DSC Lead), Toastmasters (President), IEEE}
        \resumeItem{\textbf{Honors: }President's List (All Semesters), Achievement in Computer Science Scholarship (2020-2021)}
        \resumeItem{\textbf{Relevant Coursework:} Data Structures and Algorithms,  Python for DS \& AI, Database Management Systems, Cloud Computing, Computer Networks, Operating Systems, Software Design I \& II (Java)}
      \resumeItemListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{DevOps}{: Amazon Web Services, Terraform, GitLab CI/CD} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Cloud Infrastructure Engineer Intern}{May 2021 - Jul. 2021}
      {USAA}{Plano, TX}
    \resumeItemListStart
      \resumeItem {Innovated a new directory structure for publishing automated infrastructure test results of 70 projects to an archive using GitLab CI/CD pipelines which allowed for easier feature-based auditing and reduces cluttering by 84\%.}
      \resumeItem {Modified a custom Terraform provider affecting 55 projects using GoLang to allow for automatic AWS resource tagging on one parameter if not provided by a user, or manual tagging otherwise.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Converted 42 scenes of an existing cognitive distortion detection game from Augmented Reality (handheld phone-based) to Mixed and Virtual Reality (head-mounted display) for player-experience comparisons.}
        \resumeItem{Conducted early-stage player-experience testing on 9 individuals to identify bugs and verify effective game-play engagement.}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Sports Betting House Edge Web Scraper} $|$ \emph{Python}}{}
          \resumeItemListStart
