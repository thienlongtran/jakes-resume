...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Programming Languages}{: Java, Python, HTML/CSS, JavaScript, SQL} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {Modified a custom Terraform provider utilized by 55 projects using GoLang that enabled automatic AWS resource tagging on one parameter if not provided by a developer, or optional manual tagging otherwise.}
      \resumeItem {Developed a selection of 5 AWS Systems Manager (SSM) documents and automation using Terraform and GitLab CI/CD which reduced the cost of conducting network connectivity testing by 92.38\%.}
    ...
    \resumeSubheading
      {Undergraduate Research Assistant}{January 2021 - May 2021}
