...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      ...
      {PayPal}{Austin, TX}
      \resumeItemListStart
      \resumeItem {Joining Venmo, a PayPal service, for an exciting, enriching, character-building experience this summer!}
    \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem {Modified a custom Terraform provider utilized by 55 projects using GoLang to allow for automatic AWS resource tagging on one parameter if not provided by a user, or manual tagging otherwise.}
      \resumeItem {Developed a selection of 5 AWS Systems Manager (SSM) documents and automation using Terraform and GitLab CI/CD which reduced the cost of conducting network connectivity testing by about 92.38\%.}
    \resumeItemListEnd
