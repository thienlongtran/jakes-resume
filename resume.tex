...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Science}{(Online) Atlanta, GA}
      \resumeItemListStart
        \resumeItem{\textbf{Current Courses:} Knowledge-Based AI}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        %\resumeItem{\textbf{Leadership:} Google Developer Student Club (DSC Lead), Toastmasters (President), SGA (Senator)}
...
\section{Experience}
  \resumeSubHeadingListStart
     \resumeSubheading
      {Incoming Software Engineer Intern (DevOps)}{May 2022 - Aug. 2022}
      {PayPal}{Austin, TX}
      \resumeItemListStart
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed a program that gathers 4 different attributes about users’ in-game Warframe inventory items, decreasing the time it takes to gather relevant data by 98.667\% per item page compared to manual calculation.}
